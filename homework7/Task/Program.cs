    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                {
                    Console.WriteLine("Choose your favourite genre from the list");
                    foreach(Genre genre in Enum.GetValues(typeof(Genre)))
                    {
                        Console.WriteLine(genre);
                    }
                    string chosenGenre = Console.ReadLine();
                    if(Enum.TryParse<Genre>(chosenGenre, out Genre genres))
                    {
                        ...
                        Console.WriteLine("Choose movie from the list: ");
                        string chosenMovie = Console.ReadLine();
                        currentCinema.WatchMovie(list.FirstOrDefault(x => x.Title.ToLower() == chosenMovie.ToLower()));
                    }
                    else
                    {
                        Console.WriteLine("You must choose a valid genre!");
                    }
                }
                else
                {
